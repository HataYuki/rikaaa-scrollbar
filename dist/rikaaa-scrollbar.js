(function () {
  ...
  */
  ...
  var FORCED = !IS_CONCAT_SPREADABLE_SUPPORT || !SPECIES_SUPPORT$2;
  ...
  */
  ...
  function _superPropBase(object, property) {
    while (!Object.prototype.hasOwnProperty.call(object, property)) {
      object = getPrototypeOf$3(object);
  ...
  function set$5(target, property, value, receiver) {
    if (typeof Reflect !== "undefined" && set$4) {
      set$5 = set$4;
    } else {
      set$5 = function set(target, property, value, receiver) {
        var base = superPropBase(target, property);
        var desc;

        if (base) {
          desc = getOwnPropertyDescriptor$2(base, property);
        ...
        desc = getOwnPropertyDescriptor$2(receiver, property);
        ...
        if (desc) {
          ...
          defineProperty$2(receiver, property, desc);
        } else {
          defineProperty$6(receiver, property, value);
        }
    ...
    return set$5(target, property, value, receiver);
  }

  function _set(target, property, value, receiver, isStrict) {
    var s = set$5(target, property, value, receiver || target);
  ...
  /*#__PURE__*/
  function (_Ease) {
    inherits(_Timer, _Ease);

    function _Timer(duration, loopLen) {
      var _this;

      classCallCheck(this, _Timer);

      _this = possibleConstructorReturn(this, getPrototypeOf$3(_Timer).call(this));

      set_1(getPrototypeOf$3(_Timer.prototype), "duration", duration, assertThisInitialized(_this), true);

      set_1(getPrototypeOf$3(_Timer.prototype), "type", 'linear', assertThisInitialized(_this), true);
    ...
    createClass(_Timer, [{
      key: "Timer",
      value: function Timer(func) {
        get$5(getPrototypeOf$3(_Timer.prototype), "Start", this).call(this, function () {}).End(function () {
          func();
        });
      }
    }, {
      ...
      value: function Clear() {
        get$5(getPrototypeOf$3(_Timer.prototype), "Stop", this).call(this);
      }
    }, {
      key: "duration",
      set: function set(n) {
        set_1(getPrototypeOf$3(_Timer.prototype), "duration", n, this, true);
      }
    }, {
      key: "looplen",
      set: function set(n) {
  ...
  function (_HTMLElement) {
    inherits(rikaaahoge, _HTMLElement);

    function rikaaahoge() {
      var _this;

      classCallCheck(this, rikaaahoge);

      _this = possibleConstructorReturn(this, getPrototypeOf$3(rikaaahoge).call(this));
    ...
    createClass(rikaaahoge, [{
      ...
      value: function connectedCallback() {
        ...
        this.view = this.shadowRoot.querySelector('.view'); // init hide

        if (this.autohide) this.barHide(0);
        var oneHide, oneShow;
        var timer = new _Timer(1);
        timer.Timer(function () {
          var _context3, _context6;

          // init
          _this2.redraw(0); // this.slotWrap();


          if (_this2.autohide) oneShow = onebang(function () {
          ...
          var mouseScrolling = function mouseScrolling() {
          ...
          _this2.view.addEventListener('scroll', mouseScrolling, {
            passive: true
          }); // to edge


          var scrollToEdge = function scrollToEdge(e) {
            var _context, _context2;

            var btn = e.currentTarget;
            if (includes$4(_context = from_1$2(btn.classList)).call(_context, 'main-btn')) return false;

            var dir = includes$4(_context2 = from_1$2(btn.classList)).call(_context2, 'up');

            if (dir) _this2.goTo(0, 300);else _this2.goTo(1, 300);
          };

          forEach$2(_context3 = _this2.shadowRoot.querySelectorAll('.bar-btn')).call(_context3, function (elem) {
            elem.addEventListener('click', scrollToEdge);
          }); // reiseze
          ...
          var resizeOb = new index(resize);
          resizeOb.observe(_this2); // skip

          var barContanerClick = function barContanerClick(e) {
            var _context4;

            if (!includes$4(_context4 = from_1$2(e.target.classList)).call(_context4, 'bar-contaner')) return false;
          ...
          _this2.shadowRoot.querySelector('.bar-contaner').addEventListener('click', barContanerClick); // bar scroll
          ...
          _this2.shadowRoot.querySelector('.main-btn').addEventListener('mousedown', attachslide);

          _this2.shadowRoot.querySelector('.main-btn').addEventListener('touchstart', attachslide);

          window.addEventListener('mouseup', releaseslide);
          window.addEventListener('touchend', releaseslide);
          window.addEventListener('mouseleave', releaseslide);
          window.addEventListener('touchleave', releaseslide); // bar opend and close

          var botimer;

          var barOpen = function barOpen() {
            var d = 100;
          ...
          var barClose = function barClose() {
            var d = 80;
          ...
          _this2.shadowRoot.querySelector('.bar-area').addEventListener('mouseenter', barOpen);

          _this2.shadowRoot.querySelector('.bar-area').addEventListener('mouseleave', barClose); // navi


          var navi = function navi(e) {
            var _context5;

            var dir = includes$4(_context5 = from_1$2(e.currentTarget.classList)).call(_context5, 'edge-top') ? false : true; // true is next;

            _this2.goNavigation(dir);
          };

          forEach$2(_context6 = _this2.shadowRoot.querySelectorAll('.btn')).call(_context6, function (elem) {
            elem.addEventListener('click', navi);
          }); // onload this
      ...
      value: function setBarAreaSeparation(btnH_px, btnSeparation_px, changIngAnimationDuration_ms) {
        ...
        var change = function change(ease) {
          ...
          forEach$2(_context7 = from_1$2(btn)).call(_context7, function (elem) {
            var _context8;
            ...
            if (includes$4(_context8 = from_1$2(elem.classList)).call(_context8, 'edge-top')) elem.style.marginBottom = "".concat(separation, "px");else elem.style.marginTop = "".concat(separation, "px");
          });
      ...
      value: function barAreaW(areaW, duration, timingFunc) {
        ...
        assign$2(barArea.style, {
          transition: concat$2(_context9 = "width ".concat(duration, "ms ")).call(_context9, timingFunc),
      ...
      value: function goNavigation(dir) {
        ...
        var getOffsetTop = function getOffsetTop(id) {
          ...
          return filter$2(_context10 = _this3.shadowRoot.querySelector('.contents').assignedNodes({
            flattern: true
          })).call(_context10, function (n) {
      ...
      get: function get() {
        ...
        var near = reduce$2(data).call(data, function (a, c) {
          var getOffsetTop = function getOffsetTop(id) {
            var _context11;

            return filter$2(_context11 = _this4.shadowRoot.querySelector('.contents').assignedNodes({
              flattern: true
            })).call(_context11, function (n) {
              return n.nodeType === n.ELEMENT_NODE;
            })[0].querySelector("#".concat(id)).offsetTop;
          };
        ...
        var indexs = map$2(_context12 = [indexOf$2(data).call(data, near) - 1, indexOf$2(data).call(data, near), indexOf$2(data).call(data, near) + 1]).call(_context12, function (index) {
